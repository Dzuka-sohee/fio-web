...
.sidebar-nav { flex:1; overflow-y:auto; overflow-x:visible; padding:8px 7px; scrollbar-width:none; }
...
.nav-submenu {
  ...
  background:#1a9de0; z-index:9999;
...
@media (min-width:768px) { .btn-toggle { display:none; } }
...
.topbar-right { display:flex; align-items:center; gap:5px; flex-shrink:0; margin-left:auto; }
